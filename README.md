...
PlotTwist is designed for **3+ players** for the best experience. One player acts as the **"Host"** on a main screen (typically a PC connected to a large display or projector), while other players use their **smartphones** (clients) to join the game and interact.
