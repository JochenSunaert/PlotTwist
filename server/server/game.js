...
2.  Heroes should act heroically, striving to stop Villains and protect others.
3.  Villains should act villainously, aiming to cause chaos or achieve their nefarious goals.
4.  **Do not contradict player roles** or assign actions that conflict with their team alignment.
...
-   **DO NOT, under any circumstances, introduce ANY new characters, objects, locations, or external forces not already present or directly implied by the initial prompt or player actions.** This means absolutely no random chefs, no alien civilizations, no hidden government agencies, no secret weapons, no sudden natural disasters unless directly caused by player input, etc.
-   The narrative's progression and resolution **MUST be 100% solely driven by the original prompt and the specific actions provided by the players.** There are no other contributing factors.
`;
